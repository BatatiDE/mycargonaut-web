...
export default function RideStatus({
          ...
          navigator.permissions
            ...
            .then((result) => {
              if (result.state === "granted") {
                ...
                setLocationError(
                  "Standortfreigabe wurde verweigert. Bitte aktivieren Sie die Standortfreigabe in Ihren Browsereinstellungen."
                );
                toast({
                  title: "Standortfreigabe erforderlich",
                  description:
                    "Bitte aktivieren Sie die Standortfreigabe in Ihren Browsereinstellungen.",
                  variant: "destructive",
                });
              }
            });
  ...
  const actions = isOffered
    ? currentStatus.offeredActions
    : currentStatus.bookedActions;
  ...
  return (
    <Card className="w-full">
        ...
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="text-sm text-muted-foreground">
              {type === "ride" ? "Fahrt" : "Fracht"} ID: {rideId}
            </div>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        {location && (
          <div className="text-sm text-muted-foreground">
            Aktueller Standort: {location.lat.toFixed(6)},{" "}
